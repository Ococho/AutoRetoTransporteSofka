...
public class Constantes {
    public static final String ACTOR_API = "Consumidor de APIs";
    public static final String ACTOR_WEB = "Visitante de Transportes Sofka";
    ...
    public static final String API_URL_REGISTRAR_USUARIO = "/usuario/registrar";
}